...
export const Footer = () => {
    return (
        <>
            ...
            <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded bg-[#1D232A]">
                <nav className="grid grid-flow-col gap-4">

                    {
                        navLinks.map((singleLink) => (

                            <NavLink key={singleLink.id} className='link link-hover' to={`/${singleLink.id}`}>{singleLink.title}</NavLink>
                ...
                <aside>
                    <p className={`text-[14px] leading-[25px] text-secondary mb-10`}>Portfolio Development - Inspired from Adrian</p>
